...
public class EmpregadoProxectoId implements java.io.Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof EmpregadoProxectoId))
            return false;
        EmpregadoProxectoId castOther = (EmpregadoProxectoId) other;

        return ((this.getNssempregado() == castOther.getNssempregado()) || (this.getNssempregado() != null
                && castOther.getNssempregado() != null && this.getNssempregado().equals(castOther.getNssempregado())))
