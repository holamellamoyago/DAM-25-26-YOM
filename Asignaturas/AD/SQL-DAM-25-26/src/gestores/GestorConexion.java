...
public class GestorConexion {
    ...
    /*
        MÉTODOS:
            ...
            ResultSet ejecutarConsulta (PreparedStatement)
            void    ejecutarLoteTransacioneal (la utilizamos para crear varias tablas a la vez)
            int ejecutarSentencia (executeUpdate)
            int insertarYretornarClaveGenerada
            insertarDatos
            setParametros
